      ...
      <main className="flex-1 overflow-auto">
        <div className="mx-auto max-w-[1600px] px-6 py-6">
          ...
          <div className="flex items-center gap-3 pb-4 border-b border-dark-700/60 mb-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-white">Cache Performance</h1>
              <p className="text-sm text-gray-400">Cache hit/miss ratios and effectiveness across API traffic</p>
            </div>
          </div>
          ...
          <ApigeeMetricsExplorer
            ...
            emptyFilterMessage="Select a proxy to view cache metrics"
            dimension={dimension}
            selectedMetrics={selectedMetrics}
          />
        </div>
